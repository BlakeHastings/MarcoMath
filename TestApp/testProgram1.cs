...
public static class Programmtester1{
    ...
    public static void main()
    {
     ...
     new CombinedDistribution(new List<Distribution>() {new GaussianDistribution(0, 6, 1), new GaussianDistribution(20, 6, 1) }).Shift(40),};
